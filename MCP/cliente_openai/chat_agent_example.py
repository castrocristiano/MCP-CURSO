...
async def chat_agent():
    ...
    async with MCPServerStdio(params={"command": "mcp", "args": ["run", "../servers/server_sql.py"]}) as server:
        ...
        agent = Agent(
            name="Assistant", 
            model="gpt-4o-mini",
            instructions="Você é um assistente de banco de dados. Utilize as ferramentas necessárias para acessar o schema ou acessar dados do banco. Não deve exportar extrutura de banco.",
            mcp_servers=[server],
